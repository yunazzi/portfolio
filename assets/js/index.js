...
//sc-visual
gsap.to('.sc-visual .visual-details',{
    scrollTrigger:{
        trigger:'.sc-visual .wrap',
        start:'0% 10%',
        end:'0% 0%',
        scrub:1,
    },
...
intro
    .addLabel('a')
    .from('.sc-visual .wrap em:first-child',{autoAlpha:0,y:100,duration:1,delay:1},"a")
    .from('.sc-visual .wrap em:first-child .box-line',{"transform": "scale(0)",duration:1.5,delay:1},"a")
    .from('.sc-visual .wrap em:first-child .box-wrapper',{autoAlpha:0,y:100,duration:1,delay:1.5},"a")
    .from('.sc-visual .wrap em:nth-child(2)',{autoAlpha:0,y:100,duration:1,delay:1.9},"a")
    .from('.sc-visual .wrap em:nth-child(3)',{autoAlpha:0,y:100,duration:1,delay:2.3},"a")
    .from('.sc-visual .visual-details',{autoAlpha:0,y:100,duration:1,delay:2.5},"a")
...
const contentTl = gsap.timeline({
    scrollTrigger:{
        trigger:'.sc-visual .wrap em:nth-child(2)',
        start:'-30% 0%',
        end:'100% 100%',
    }
})
...
if(window.matchMedia("(min-width:769px").matches){ //768px이상
    ...
    contactTl.from('.sc-contact .contact-content .sm-con',{autoAlpha:0,y:100,duration:1,delay:1.1},"e")
    contactTl.from('.sc-contact .contact-content .line',{width:0,duration:1,delay:1},"e")


    $('.sc-contact .contact-content .out-title').each(function(i,el){
        gsap.from($(this),{
            scrollTrigger:{
                trigger:$(this),
                start:'-540% 0%',
    ...
    $('.sc-contact .contact-content .con-line').each(function(i,el){
        gsap.from($(this),{
            scrollTrigger:{
                trigger:$(this),
                start:'-90000% 0%',
...
$('.out-title').mouseenter(function(){
    $(this).siblings('.in-title').css({opacity:1,transform: "scaleY(1)"})
})
$('.out-title').mouseleave(function(){
    $(this).siblings('.in-title').css({opacity:0,transform: "scaleY(0)"})
})
